...
<!-- <body style="background-image:url(img/Photoback.png);"rgb(240,242,245)> -->
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-6">
                        <div class="header__top__right">
                            ...
                            <div class="header__top__right__auth">
                                <a href="index" style="font-family:candara;color:black; text-decoration:none; font-weight:bold;"><i class="fa fa-user"></i> Rester sur Bambino Boss</a>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <nav class="header__menu">
                        <ul>
                            <li style="font-family:candara; text-decoration:none;" class="active"><a href="">accueil</a></li>
                            <li style="font-family:candara; text-decoration "><a href="collection_products">Collections</a></li>
                            <li style="font-family:candara; text-decoration"><a href="Blog">Blog</a></li>
                            <!-- <li style="font-family:candara;"><a href="./contact.html">Contact</a></li> -->
                            <li style="font-family:candara; text-decoration"><a href="about">About us</a></li>
                        </ul>
                    </nav>
                </div>
                <div class="col-lg-3">
                    ...
                    <div class="hero__categories"style="background-color:rgb(255,255,255);border-radius:10px;">
                        ...
                        <ul>
                            ...
                            <li style="font-family:candara;" class="dropdown w-100">
                              <a href="" class="pl-3">
                                <i class="fa fa-tty pr-2" aria-hidden="true" style="color:black;text-decoration:none;"></i>
                              ...
                              <div class="dropdown-content border-0 ">          
                                    <div class="row">
                                      <div class="col-lg-12" >
                                        ...
                                        <a href=""><li>Gant de toilette & Serviettes</li></a> 
                                        <a href=""><li>Couches jetable</li></a> 
                                        </ul>
                                      </div> 
                                    </div> 
                                </div>
                                    ...
                                    <div class="row">
                                      <div class="col-lg-12" >
                                        <ul class="border-0">
                                          ...
                                          <a href="accessoires"><li>Succettes et accessoires </li></a> 
                                        </ul>
                                      </div> 
                                    </div> 
                                </div>
