    ...
    <section class="latest-product spad" style="margin-top:-60px;">
        ...
        <div class="filter__item">
            ...
            <table class="table table-bordered table-striped">
              <thead>
                <tr>
                  <th style="font-family:candara;">Rendering engine</th>
                  <th style="font-family:candara;">Browser</th>
                  <th style="font-family:candara;">Platform(s)</th>
                  <th style="font-family:candara;">Engine version</th>
                  <th style="font-family:candara;">CSS grade</th>
                </tr>
              </thead>
              <tbody>
                <?php 
                    $dolalrd="$";
                            $myqwery=$db->prepare("SELECT * FROM commande_ord ORDER BY id DESC limit 16 ");
                            $myqwery->execute();
                            foreach($myqwery->fetchAll(PDO::FETCH_OBJ) as $token): 
                ?>
                <tr class="odd gradeX">
                  <td><?=$token->nomcomple;?></td>
                  <td><?=$token->email;?></td>
