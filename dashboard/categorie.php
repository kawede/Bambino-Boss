            ...
            <div class="col-lg-12">
              ...
              <div class="card mb-4">
                ...
                if (isset($_POST['btninscrit'])) {
                 ...
                 if ($designation&&$slag) {
                 $myqwery=$db->prepare("INSERT INTO categorie (designation,slag) VALUES(:designation,:slag)");
                 $myqwery->execute(array(
                 ...
                 if ($myqwery){
                 echo '<b class="text-danger text-center alert alert-success"><i class="fa fa-check" aria-hidden="true"></i>Categorie ajoutée</b>';
                 }  
                  ...
                  <form action="" method="POST">
                   <div class="form-group row">
                      <div class="col-sm-12 mb-3 mb-sm-0">
                        <input type="text" class="form-control " name="designation"style="color:black;font-family:candara; font-weight:bold;"  id="exampleFirstName" placeholder="nom complet" >
                      </div>
                    </div>
                     <div class="form-group row">
                      <div class="col-sm-12">
                        <input type="text" class="form-control"style="color:black;font-family:candara; font-weight:bold;" name="slag" value="<?php echo uniqid('', false); ?>"  id="exampleSecondName" style="color:red; font-family:candara; font-weight:bold;" readonly="readonly">
                      </div>
                    </div>
